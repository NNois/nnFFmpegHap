...
typedef struct BC7Enc16Context {
  int (*bc7enc16_block)        (uint8_t* dst, ptrdiff_t stride, const uint8_t* block);
} BC7Enc16Context;

// Recommended settings: perceptual=true, max_partitions_to_scan=BC7ENC16_MAX_PARTITIONS1, uber_level=0
void ff_bc7enc16_init(BC7Enc16Context* c, bc7enc16_bool perceptual, int max_partitions_to_scan, int uber_level);
