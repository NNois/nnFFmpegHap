...
set "ZLIB_INSTALL=C:\ff\ff\build-msvc\zlib-msvc"
set "ZLIB_VER=1.3.1"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "(Get-Content 'win32\Makefile.msc') -replace '-MT','-MD' | Set-Content 'win32\Makefile.msc'"
