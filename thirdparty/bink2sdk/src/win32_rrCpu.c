...
#define _SSE4_1_FEATURE_BIT     (1u << 19)
rrbool rrCPU_HasSSE4( void )
{
  static U32 checked = 0;
  if (checked == 0) {
    int cpuid_info[4];
    __cpuid(cpuid_info, 1);
    checked = (cpuid_info[2] & (1u << 19)) ? 2 : 1;
  }
  return checked == 2;
}
...
{
  rrcpu_features features = { 0 };
  int cpuid_info[4];

  features.initialized = 1;
  __cpuid(cpuid_info, 1);

  features.sse2   = (cpuid_info[3] & (1u << 26)) != 0;
  features.ssse3  = (cpuid_info[2] & (1u <<  9)) != 0;
  features.sse4_1 = (cpuid_info[2] & (1u << 19)) != 0;
  features.sse4_2 = (cpuid_info[2] & (1u << 20)) != 0;
  features.popcnt = (cpuid_info[2] & (1u << 23)) != 0;
  features.avx    = (cpuid_info[2] & (1u << 28)) != 0;
  ...
  features.bmi1   = (cpuid_info[1] & (1u <<  3)) != 0;
  features.avx2   = (cpuid_info[1] & (1u <<  5)) != 0;
  features.bmi2   = (cpuid_info[1] & (1u <<  8)) != 0;
  features.avx512 = (cpuid_info[1] & (1u << 16)) != 0;
...
#else // defined(DLL_FOR_GENERIC_OS)
