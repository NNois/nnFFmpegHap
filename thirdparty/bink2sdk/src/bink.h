...
EXPGROUP(_NullGroup)
#define BinkDate    "2025-05-22" EXPMACRO    

#define BinkVersion     "2025.05" EXPMACRO
#define BinkMajorVersion    2025  EXPMACRO    
...
typedef BINKSNDOPEN  (RADLINK * BINKSNDSYSOPEN4) (UINTa param1, UINTa param2, UINTa param3, UINTa param4);
...
typedef struct BINK {
  ...
  S32 async_count;            // count of async threads that are running
  U8 async_done[ 192 ];       // semaphore tracking done state
...
RADEXPFUNC S32  RADEXPLINK BinkSetSoundSystem4(BINKSNDSYSOPEN4 open, UINTa param1, UINTa param2, UINTa param3, UINTa param4);
...
#define BinkSoundUseXAudio2WinDevice(wchar_ptr_to_device_name) BinkSetSoundSystem2(BinkOpenXAudio2,(UINTa)(-2), (UINTa)(wchar_ptr_to_device_name))

// on desktop windows, BinkSoundUseXAudio2 will call one of these three functions automatically, 
...
#define BinkSoundUseXAudio29(IXAudio2_ptr, IXAudio2MasteringVoice_ptr) BinkSetSoundSystem2(BinkOpenXAudio29,(UINTa)(IXAudio2_ptr), (UINTa)(IXAudio2MasteringVoice_ptr))
...
RADEXPFUNC BINKSNDOPEN RADEXPLINK BinkOpenXAudio2ss( UINTa frequency, UINTa num_speakers, UINTa IXAudio2_ptr, UINTa IXAudio2MasteringVoice_ptr );// don't call directly
#define BinkSoundUseXAudio2ss( frequency, number_of_speakers, IXAudio2_ptr, IXAudio2MasteringVoice_ptr ) BinkSetSoundSystem4( BinkOpenXAudio2ss, frequency, number_of_speakers, (UINTa)(IXAudio2_ptr), (UINTa)(IXAudio2MasteringVoice_ptr) )

RADEXPFUNC BINKSNDOPEN RADEXPLINK BinkSoundUseXAudio2ssWinDevice( UINTa frequency, U32 num_speakers, U16 * wchar_ptr_to_device_name ); // don't call directly
#define BinkSoundUseXAudio2ssWinDevice( frequency, number_of_speakers, IXAudio2_ptr, IXAudio2MasteringVoice_ptr ) BinkSetSoundSystem4( BinkOpenXAudio2ss, frequency, number_of_speakers,(UINTa)(-2), (UINTa)(wchar_ptr_to_device_name) )

// on desktop windows, BinkSoundUseXAudio2 will call one of these three functions automatically, 
//    but you can directly call, if you want to be sure you are getting the correct version
#define BinkSoundUseXAudio27ss(frequency, number_of_speakers, IXAudio2_ptr, IXAudio2MasteringVoice_ptr) BinkSetSoundSystem4(BinkOpenXAudio27ss,frequency, number_of_speakers,(UINTa)(IXAudio2_ptr), (UINTa)(IXAudio2MasteringVoice_ptr))
#define BinkSoundUseXAudio28ss(frequency, number_of_speakers, IXAudio2_ptr, IXAudio2MasteringVoice_ptr) BinkSetSoundSystem4(BinkOpenXAudio28ss,frequency, number_of_speakers,(UINTa)(IXAudio2_ptr), (UINTa)(IXAudio2MasteringVoice_ptr))
#define BinkSoundUseXAudio29ss(frequency, number_of_speakers, IXAudio2_ptr, IXAudio2MasteringVoice_ptr) BinkSetSoundSystem4(BinkOpenXAudio29ss,frequency, number_of_speakers,(UINTa)(IXAudio2_ptr), (UINTa)(IXAudio2MasteringVoice_ptr))

// on desktop windows, BinkSoundUseXAudio2 will call one of these three functions automatically, 
//    but you can directly call, if you want to be sure you are getting the correct version
RADEXPFUNC BINKSNDOPEN RADEXPLINK BinkOpenXAudio27ss( UINTa frequency, UINTa num_speakers, UINTa IXAudio2_ptr, UINTa IXAudio2MasteringVoice_ptr ); // don't call directly
RADEXPFUNC BINKSNDOPEN RADEXPLINK BinkOpenXAudio28ss( UINTa frequency, UINTa num_speakers, UINTa IXAudio2_ptr, UINTa IXAudio2MasteringVoice_ptr ); // don't call directly
RADEXPFUNC BINKSNDOPEN RADEXPLINK BinkOpenXAudio29ss( UINTa frequency, UINTa num_speakers, UINTa IXAudio2_ptr, UINTa IXAudio2MasteringVoice_ptr ); // don't call directly
