...
#if defined(__RADIOS__) && defined(__RADX64__)

#define CPU_check( u, du )
#define CPU_can_use( has ) ( ( has & ( CPU_SSE | CPU_SSE2 | CPU_SSE3 | CPU_SSSE3 ) ) == has )
#define CPU_can_use_any( has ) ( has & ( CPU_SSE | CPU_SSE2 | CPU_SSE3 | CPU_SSSE3 ) )
#define CPU_features() ( CPU_SSE | CPU_SSE2 | CPU_SSE3 | CPU_SSSE3 )
#define CPU_clean_up() 
#define CPU_ALWAYS_SSE
#define CPU_ALWAYS_SSE2
#define CPU_ALWAYS_SSE3
#define CPU_ALWAYS_SSSE3
#define CPU_MMX   1
#define CPU_3DNOW 2
#define CPU_SSE   4
#define CPU_SSE2  8
...
#define POPCOUNT32_INTRINSIC __builtin_popcount
...
// everything necessary defined above
