...
# Usage: bash build-bink2sdk.sh
# Output: libbink2sdk.a (static library)
#         build-bink2sdk.log (build log)
set -e

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
SDK_SRC="$SCRIPT_DIR/src"
OUT_DIR="$SCRIPT_DIR/build_mingw"
LOG_FILE="$SCRIPT_DIR/build-bink2sdk.log"
...
$CC $CFLAGS -c "${SCRIPT_DIR}/bink2sdk_shims.c" -o "$OUT_DIR/bink2sdk_shims.o"
echo "  OK"
